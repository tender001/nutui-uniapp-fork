<template>
    <view class="register">
      <view class="register-title">实名认证</view>
      <nut-form ref="formRef" :model-value="form" custom-class="register-form nut-form-custom">
        ...
        <nut-form-item label="验证码" prop="code" :rules="[
        ...
        <nut-form-item>
          <nut-button custom-class="nut-form-btn" size="large" block type="primary" @click="onSubmit">注册</nut-button>
        </nut-form-item>
