<template>
  <div class="home">
    <div class="user-tabs">
      <div class="user-tabs-title">小白菜飞手</div>
      ...
      <nut-tabs v-model="userType" size="large" type="smile">
        ...
        <nut-tab-pane title="飞手" pane-key="2">
          <div v-if="pilotStatus === 1">
            <image @click="navigateTo('/pages/bookingHall/index')" class="tabs-image" mode="widthFix"
              src="https://oss.6780.cn/pilot/WX20240521-223815@2x.png" />
            <div class="home-content">
          ...
          <div v-else>
            <image class="tabs-image" mode="widthFix" src="https://oss.6780.cn/pilot/WX20240521-223711@2x.png" />
            <div class="home-content">
